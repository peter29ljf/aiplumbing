...
def standing(phase: str, project: Project | None = None) -> str:
    ...
    if project is not None:
        parts.append(
            ...
            f"`{PRESETS / 'world.md'}` is the whole surface a tool may ask the world "
            f"for, including `world.record` for this business's own nouns; a generated "
            f"project invented two world methods that do not exist by not reading it. "
